...
describe('rgbToHexColor', () => {
    it('should return undefined if red value is invalid', () => {
       // Arrange
        ...
        const negativeRedValueResult = rgbToHexColor(-1, 0, 0);
    ...
    it('should return undefined if green value is invalid', () => {
        ...
        const negativeGreenValueResult = rgbToHexColor(0, -1, 0);
    ...
    it('should return undefined if blue value is invalid', () => {
       // Arrange
        ...
        const negativeBlueValueResult = rgbToHexColor(0, 0, -1);
    ...
    it('should return undefined a correct hex value if a correct rgb is given', () => {
        // Arrange
        const redValue = 223;
    ...
    it('should return undefined a correct hex value if a max rgb is given', () => {
        // Arrange
        const redValue = 255;
