...
namespace TownApplication.IntegrationTests
{
    public class TownControllerIntegrationTests
    {
        ...
        public void AddTown_ValidInput_ShouldAddTown()
        {
            ...
            var result = _controller.GetTownByName(validTown);
        ...
        public void AddTown_InvalidPopulation_ShouldThrowArgumentException(int invalidPopulation)
        {
            ...
            // Replace the placeholder value with actual valid data.
            var townNane = "Awesometown";
            

            // Act: Execute the action to be tested.
            // Wrap the call to AddTown in an Action delegate to use with Assert.Throws.
            var action = () => _controller.AddTown(townNane, invalidPopulation);

            //var exeption = Assert.Throws<ArgumentException>(() => _controller.AddTown(townNane, invalidPopulation));
        ...
        //[InlineData(0)]
        //[InlineData(-1)]
        //public void UpdateTown_InvalidPopulationShouldThrowArgumentException(int invalidPopulation)
        //{
        //    // Arrange
        //    var townName = "Varna";
        //    var initialPopulation = 100;
        ...
        public void ListTowns_ShouldReturnTowns()
        {
            ...
            //_controller.AddTown("Varna", 100);
            //_controller.AddTown("Silistra", 200);
            //_controller.AddTown("Burgas", 300);

            var townsToAdd = new List<string> {"Varna", "Silistra" , "Burgas"};
